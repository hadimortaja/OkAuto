...
//   formData: FormData.fromMap( {"category_id": "2", "city_id": "3", "brand_id": "378", "style_id": "7467", "second_category": null, "color_id": "2", "name": "Test Truck", "photo_main": '', "price": "21121212", "content": "djnasnsjdknsjsjdk", "type_product": "for_sale", "condition": "New", "production_year": "1984", "kilometer": "1212", "address": "2112", "whatsapp": "12121212", "description": "djnasnsjdknsjsjdk", "phone": "21122112", "photo_ads[0]":"",  "service_id": null, "plan_id": "3", "number_type": null, "vehicle_type": null, "vehicle_number": null, "code": null, "photo_link": null, "price_daily": null, "price_monthly": null, "price_yearly": null, "status": 1, "sim_type": null}));
//   log(uploadAdsController.imagesAds![0].path);
  ...
  if (response != null) {
    ...
    appController.controller.animateTo(3);
    BotToast.showText(
        text: "Ads Added Successfully", contentColor: AppColors.green);
