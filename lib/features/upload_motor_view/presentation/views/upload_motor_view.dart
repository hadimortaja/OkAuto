...
class UploadMotorView extends StatefulWidget {
  @override
  State<UploadMotorView> createState() => _UploadMotorViewState();
}

class _UploadMotorViewState extends State<UploadMotorView> {
            ...
            children: [
              GetBuilder<UploadAdsController>(
                ...
                builder: (controller) {
                  return CustomButton(
                    onTap: () {
                      if (controller.indexMotorStepper == 0) {
                        if (uploadAdsController
                          ...
                          controller.setIndexMotorStepper(1);
                        }
                      } else if (controller.indexMotorStepper == 1) {
                        if (uploadAdsController.imagesAds!.length == 0) {
                          BotToast.showText(
                              text: "Please Add at least 1 image".tr);
                        } else {
                          controller.setIndexMotorStepper(2);
                        }
                      } else if (controller.indexMotorStepper == 2) {
                        if (authController.getCitiesSelect.value.name == null) {
                          ...
                          controller.setIndexMotorStepper(3);
                        }
                      } else {
                    ...
                    width: 329.w,
                    height: 59.h,
                    title: controller.indexMotorStepper == 3
                        ? "Publish Now"
                        : "Continue",
                  );
                },
          ...
          builder: (controller) {
            return Column(
                ...
                children: [
                  ...
                  StepperMotor(controller.indexMotorStepper),
                  SizedBox(
                    height: 20.h,
                  ),
                  Expanded(
                      child: SingleChildScrollView(
                    child: controller.indexMotorStepper == 0
                        ? Form(
                            key: formKey,
                            child: Padding(
                        ...
                        : controller.indexMotorStepper == 1
                            ? Padding(
                                padding: EdgeInsets.symmetric(horizontal: 16.w),
                                child: Column(
                                    crossAxisAlignment:
                            ...
                            : controller.indexMotorStepper == 2
                                ? Form(
                                    key: formKey1,
                                    child: Padding(
