...
class UploadCarView extends StatefulWidget {
  final bool? isClassic;
  UploadCarView({this.isClassic = false});
  @override
  State<UploadCarView> createState() => _UploadCarViewState();
}

class _UploadCarViewState extends State<UploadCarView> {
                    ...
                    onTap: () {
                      if (controller.indexStepper == 0) {
                        ...
                        Get.to(() => ChoosePlanView(
                              categoryId: widget.isClassic == true ? "5" : "1",
                            ));
                      }
                    },
                    width: 329.w,
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        CustomText(
                          widget.isClassic == true ? "Classic Cars" : "Cars",
                          fontSize: 22.sp,
                          fontFamily: "tajawalb",
                        ),
                        IconButton(
