...
class UploadBoatView extends StatefulWidget {
  final bool? isClassic;
  UploadBoatView({this.isClassic = false});
  @override
  State<UploadBoatView> createState() => _UploadBoatViewState();
}

class _UploadBoatViewState extends State<UploadBoatView> {
            ...
            children: [
              GetBuilder<UploadAdsController>(
                ...
                builder: (controller) {
                  return CustomButton(
                    onTap: () {
                      if (controller.indexBoatStepper == 0) {
                        if (uploadAdsController
                          ...
                          controller.setIndexBoatStepper(1);
                        }
                      } else if (controller.indexBoatStepper == 1) {
                        if (uploadAdsController.imagesAds!.length == 0) {
                          BotToast.showText(
                              text: "Please Add at least 1 image".tr);
                        } else {
                          controller.setIndexBoatStepper(2);
                        }
                      } else if (controller.indexBoatStepper == 2) {
                        if (authController.getCitiesSelect.value.name == null) {
                          ...
                          controller.setIndexBoatStepper(3);
                        }
                      } else {
                    ...
                    width: 329.w,
                    height: 59.h,
                    title: controller.indexBoatStepper == 3
                        ? "Publish Now"
                        : "Continue",
                  );
                },
          ...
          builder: (controller) {
            return Column(
                ...
                children: [
                  ...
                  StepperBoat(controller.indexBoatStepper),
                  SizedBox(
                    height: 20.h,
                  ),
                  Expanded(
                      child: SingleChildScrollView(
                    child: controller.indexBoatStepper == 0
                        ? Form(
                            key: formKey,
                            child: Padding(
