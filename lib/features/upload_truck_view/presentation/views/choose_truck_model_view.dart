...
class ChooseTruckModelView extends StatelessWidget {
  String? id;
  ChooseTruckModelView({this.id});
                  ...
                  onTap: () {
                    if (id != null) {
                      getProductsByCategoryDataSource(
                        ...
                        true,
                        id!,
                        brand: authController.getTruckModelSelect.value.id
                            .toString(),
                      );
                    }
                    Get.back();
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(() {
                        return authController.getTruckModelsData.value.code ==
                                null
                            ? Helper.loading()
                            : authController.getTruckModelsData.value.data!
                                        .length ==
                                    0
                                ? Column(
                                    children: [
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return GestureDetector(
                                          onTap: () {
                                            controller
                                                .setIndexTruckModel(index);
                                            authController
                                                    .getTruckModelSelect.value =
                                                authController
                                                    .getTruckModelsData
                                                    .value
                                                    .data![index];
